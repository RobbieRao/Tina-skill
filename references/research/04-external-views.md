# 04 - External Views, Awards, and Criticism
...
- AiDLab event page and PolyU news independently list the same Geneva award for the AI-driven headwear customization system.
  Sources: https://www.aidlab.hk/en/event-detail/49th-international-exhibition-of-inventions-geneva and https://www.polyu.edu.hk/feng/news-and-events/news/2024/20240423-polyu-wins-record-breaking-number-of-awards-at-international-exhibition-of-inventions-genev/
  Confidence: high.

- PolyU profile and RAE2026 PDF list AdaptSpecs as a 2023 IDEA Silver Award winner. The RAE PDF says AdaptSpecs was designed for people who have difficulty wearing regular eyewear because typical frames rely on the nose bridge and ears.
  Sources: PolyU profile and local PDF copy.
  Confidence: high.

- Google Scholar and OpenAlex citation records show meaningful academic uptake, especially around head/face anthropometry, 3D modeling, older adult mobile usability, and trust in AI / robots.
  Sources: https://scholar.google.com/citations?hl=en&user=yRMNWQ0AAAAJ and https://api.openalex.org/authors/A5083045543
...
- Many flagship systems are population-specific, especially Chinese head / face data. This is a strength for fit and inclusion, but models may not generalize without new data.
- Much of the public evidence is academic and institutional. It documents research outputs well but reveals little about private decision-making or spontaneous reasoning.
- Some product-system claims depend on prototypes, awards, and selected validations. Commercial-scale or regulatory-scale evidence is not always visible in public sources.
- The voice model is weak because interviews / transcripts are scarce.
